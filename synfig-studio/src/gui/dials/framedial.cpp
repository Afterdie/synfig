...
FrameDial::FrameDial():
	...
	seek_prev_waypoint (create_button("animate_seek_prev_keyframe_icon" , _("Seek to previous waypoint"))),
	...
	seek_next_waypoint (create_button("animate_seek_next_keyframe_icon" , _("Seek to next waypoint"))),
